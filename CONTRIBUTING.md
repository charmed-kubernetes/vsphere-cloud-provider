...
- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/vsphere-cloud-provider-operator/issues) explaining your use case.
...
# Deploy the charm
juju deploy ./vsphere-cloud-provider-operator_ubuntu-20.04-amd64.charm \
